    ...
    public partial class Baskets : Form
    {
        ...
        private void DgvSiparisler_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (OdenecekUrun.Count() != 0)
            {
                ...
                if (int.Parse(SiparisUrunu[0]["Adet"].ToString()) > 1)
                {
            ...
            else
            {
                dtOdenecekler.Rows.Add(
                      SiparisUrunu[0]["id"].ToString(),
                      SiparisUrunu[0]["Ürün"].ToString(),
                      1,
                      SiparisUrunu[0]["Fiyat"].ToString()
                      );
                if (int.Parse(SiparisUrunu[0]["Adet"].ToString()) > 1)
                {
                    SiparisUrunu[0]["Adet"] = int.Parse(SiparisUrunu[0]["Adet"].ToString()) - 1;
            ...
            LBLToplamFiyat.Text = ToplamFiyat.ToString("N") + " TL";
        ...
        private void BtnHepsiniAktar_Click(object sender, EventArgs e)
        {
            ...
            LBLOdenecekFiyat.Text = odenecekFiyat.ToString("N") + " TL";
        }
        ...
        private void BtnOdeme_Click(object sender, EventArgs e)
        {
            if (DgvOdenecekler.Rows.Count > 0 && CbOdemeTipi.SelectedIndex != -1)
            {
                ...
                orders.TotalPrice = decimal.Parse(LBLOdenecekFiyat.Text.ToString().Replace(" TL",""));
        ...
        {
            int TiklananSatir = int.Parse(DgvSiparisler.CurrentRow.Index.ToString());
            int UrunId = int.Parse(DgvSiparisler.Rows[TiklananSatir].Cells[0].Value.ToString());
